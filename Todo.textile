h1. TO DO Items
-Properties should belong to users-
-Users should be able to become admins-
-Fixed breaking tests-
-Date picker provide the right format-
-Add a bunch of fake properties and reservations-
-A logged in user should see their property at the root-
(NEED TO ADD A TEST FOR THIS!!!)
-Users should not be able to create a new property-
-Users should only be able to see their property- 
-Admin users should be able to see any property-

Admins should be able to properly destroy a reservation
